...
void InterfaceGasLaws::InterfaceFunction()
{
	...
	while(choice != 0)
	{
		...
		//cout << "If you wish to get the density of a substance, press 1." << endl;
		//cout << "If you wish to get protons, neutrons, or electrons, press 2." << endl;
		...
		//cout << "If you wish to get the Molarity of a solution, press 8." << endl;
		//cout << "If you wish to get the Molality of a solution, press 9." << endl;
		cout << "" << endl;
