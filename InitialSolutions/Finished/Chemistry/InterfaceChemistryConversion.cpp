...
void InterfaceChemistryConversion::InterfaceFunction()
{
	...
	while(choice != 0)
	{
		cout << "If you wish to leave, press 0." << endl;
...
void InterfaceChemistryConversion::Pressure()
{
	double p1, p2, p3, p4, p5;
	int choice;
	cout << "If you wish to convert from atm to mmHg, press 1." << endl;
...
void InterfaceChemistryConversion::PotentialOfHydrogen()
{
	double p1, p2, p3, p4, p5;
	int choice;
	cout << "If you wish to convert from pH to pOH, press 1." << endl;
...
void  InterfaceChemistryConversion::GramsAndKilograms()
{
	double p1, p2, p3, p4, p5;
	int choice;
	cout << "If you wish to convert from grams to kilograms, press 1." << endl;
...
void InterfaceChemistryConversion::LitersAndMililiters()
{
	...
	cout << "If you wish to convert from Liters to mililiters, press 1." << endl;
...
void InterfaceChemistryConversion::GramsAndMoles()
{
	...
	cout << "If you wish to convert from grams to moles, press 1." << endl;
...
void InterfaceChemistryConversion::Temperature()
{
	...
	while(choice != 0)
	{
		cout << "If you wish to exit, press 0." << endl;
