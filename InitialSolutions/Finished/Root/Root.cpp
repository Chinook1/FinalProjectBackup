...
void Root::InitializePrimeNumbers()
{
	/*
...
vector<int> Root::getPrime(int intVal)
{
	...
	//such as 8.
	while(j < primeNumbers.size()/*46*/ && intVal > primeNumbers[j])
	{
...
void Root::CalcRoot(int root, int number)
{
	int inside = 1;
	int outside = 1;
	vector<int> kl;
