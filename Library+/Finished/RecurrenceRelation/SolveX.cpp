...
void SolveX::FindXY(double X1, double Y1, double Ans1, double X2, double Y2, double Ans2)
{
...
double SolveX::getXVal()
{
	return answerX;
}

double SolveX::getYVal()
{
	return answerY;
}

double SolveX::getXX1()
{
	return XX1;
}

double SolveX::getYY1()
{
	return YY1;
}

double SolveX::getAA1()
{
	return AA1;
}

double SolveX::getXX2()
{
	return XX2;
}

double SolveX::getYY2()
{
	return YY2;
}

double SolveX::getAA2()
{
	return AA2;
}
